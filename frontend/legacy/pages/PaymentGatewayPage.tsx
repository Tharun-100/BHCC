...
const PaymentGatewayPage: React.FC = () => {
  ...
  const { orderId, gatewayOrderId, amount, amountPaise, currency, doctorName, appointmentDate } =
    location.state || {};
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-100">
        <div className="text-center">
          ...
          <button onClick={() => navigate('/book')} className="mt-4 px-6 py-2 bg-sky-600 text-white rounded-lg">
            Return to Booking
          </button>
        </div>
      </div>
  ...
  }, [amountPaise, currency, doctorName, gatewayOrderId, navigate, orderId]);
        ...
        <div className="p-8">
          ...
          {!error ? (
            ...
            <div className="bg-red-50 border border-red-100 rounded-xl p-4 text-center">
              ...
              <button onClick={() => navigate('/book')} className="mt-4 px-5 py-2 bg-sky-600 text-white rounded-lg font-semibold">
                Back to Booking
              </button>
            </div>
          )}
